...
from database import TradeHistory, init_db, insert_trade
import csv
import shutil
...
# @app.post("/insertTradeHistory")
# def insert_trade_history(tradeHistory: TradeHistory):        
#     insert_trade(tradeHistory)
...
def getSignals():
    ...
    try:
        # 获取数据并计算指标
        df1 = get_all_indicators(TIME_FRAME_1H, SYMBOL_BTC)
        df2 = get_all_indicators(TIME_FRAME_4H, SYMBOL_BTC)
        df3 = get_all_indicators(TIME_FRAME_1H, SYMBOL_ETH)
        df4 = get_all_indicators(TIME_FRAME_4H, SYMBOL_ETH)
        df5 = get_all_indicators(TIME_FRAME_1H, SYMBOL_BNB)
        df6 = get_all_indicators(TIME_FRAME_4H, SYMBOL_BNB)
        
        display1 = getDisplay(SYMBOL_BTC, df1)
        display2 = getDisplay(SYMBOL_BTC, df2)
        display3 = getDisplay(SYMBOL_ETH, df3)
        display4 = getDisplay(SYMBOL_ETH, df4)
        display5 = getDisplay(SYMBOL_BNB, df5)
        display6 = getDisplay(SYMBOL_BNB, df6)
